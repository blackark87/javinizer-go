...
- Commit completed changes and push them directly to `origin/feature/mediainfo-source-tags`; deployment builds the Docker image locally from this branch on the Ubuntu host.
