        ...
        "/api/v1/completed-content": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search title, movie ID, path, or actress name",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_javinizer_javinizer-go_internal_api_contracts.CompletedContentListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "github_com_javinizer_javinizer-go_internal_api_contracts.CompletedContentListResponse": {
            ...
            "properties": {
                ...
                "contents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_javinizer_javinizer-go_internal_api_contracts.CompletedContentItem"
                    }
                },
                "limit": {
                    "type": "integer",
