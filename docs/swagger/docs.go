...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/actresses/sync-jobs/{jobID}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Actress sync job ID",
                        "name": "jobID",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/batch/{id}/results/{resultId}/candidate-selection": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_javinizer_javinizer-go_internal_api_contracts.CandidateSelectionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_javinizer_javinizer-go_internal_api_contracts.CandidateSelectionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_javinizer_javinizer-go_internal_api_contracts.CandidateSelectionRequest": {
            "type": "object",
            "required": [
                "source"
            ],
        ...
        "github_com_javinizer_javinizer-go_internal_api_contracts.CandidateSelectionResponse": {
            "type": "object",
            "properties": {
                "actress_sources": {
                    "type": "object",
