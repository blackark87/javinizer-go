...
type BatchScrapeRequest struct {
	...
	RefreshTranslationOnly bool              `json:"refresh_translation_only" example:"false"`        // Re-translate DB-cached metadata without querying scrapers or regenerating artwork
