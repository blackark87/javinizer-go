...
func (d *Downloader) downloadCover(ctx context.Context, movie *models.Movie, destDir string, multipart *MultipartInfo, sourcePath ...string) (*DownloadResult, error) {
	if !d.config.DownloadCover || movie.Poster.CoverURL == "" {
		return &DownloadResult{Type: MediaTypeCover, Downloaded: false}, nil
	}

	tmplCtx := d.buildTemplateContext(movie, multipart, sourcePath...)
...
func (d *Downloader) downloadPoster(ctx context.Context, movie *models.Movie, destDir string, multipart *MultipartInfo, sourcePath ...string) (*DownloadResult, error) {
...
func (d *Downloader) downloadExtrafanart(ctx context.Context, movie *models.Movie, destDir string, multipart *MultipartInfo, enabled bool, sourcePath ...string) ([]DownloadResult, error) {
...
func (d *Downloader) downloadTrailer(ctx context.Context, movie *models.Movie, destDir string, multipart *MultipartInfo, sourcePath ...string) (*DownloadResult, error) {
...
func (d *Downloader) downloadAllWithExtrafanart(ctx context.Context, movie *models.Movie, destDir string, multipart *MultipartInfo, extrafanartEnabled bool, sourcePath ...string) ([]DownloadResult, error) {
	results := make([]DownloadResult, 0)
	...
	coverResult, _ := d.downloadCover(ctx, movie, destDir, multipart, sourcePath...)
	if coverResult != nil {
	...
	// Download poster
	posterResult, _ := d.downloadPoster(ctx, movie, destDir, multipart, sourcePath...)
	if posterResult != nil {
	...
	extrafanart, _ := d.downloadExtrafanart(ctx, movie, destDir, multipart, extrafanartEnabled, sourcePath...)
	...
	// Download trailer
	if trailerResult, _ := d.downloadTrailer(ctx, movie, destDir, multipart, sourcePath...); trailerResult != nil {
