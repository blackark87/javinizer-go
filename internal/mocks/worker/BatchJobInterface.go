...
// ApplyCandidateSelection provides a mock function for the type MockBatchJobInterface
func (_mock *MockBatchJobInterface) ApplyCandidateSelection(ctx context.Context, resultID string, source string) (*worker.MovieResult, *worker.ProvenanceData, error) {
	ret := _mock.Called(ctx, resultID, source)

	if len(ret) == 0 {
		panic("no return value specified for ApplyCandidateSelection")
	}

	var r0 *worker.MovieResult
	var r1 *worker.ProvenanceData
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) (*worker.MovieResult, *worker.ProvenanceData, error)); ok {
		return returnFunc(ctx, resultID, source)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) *worker.MovieResult); ok {
		r0 = returnFunc(ctx, resultID, source)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*worker.MovieResult)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string) *worker.ProvenanceData); ok {
		r1 = returnFunc(ctx, resultID, source)
	} else {
		if ret.Get(1) != nil {
	...
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string) error); ok {
		r2 = returnFunc(ctx, resultID, source)
	} else {
		r2 = ret.Error(2)
	}
	return r0, r1, r2
...
// MockBatchJobInterface_ApplyCandidateSelection_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ApplyCandidateSelection'
type MockBatchJobInterface_ApplyCandidateSelection_Call struct {
	*mock.Call
}

// ApplyCandidateSelection is a helper method to define mock.On call
//   - ctx context.Context
//   - resultID string
//   - source string
func (_e *MockBatchJobInterface_Expecter) ApplyCandidateSelection(ctx any, resultID any, source any) *MockBatchJobInterface_ApplyCandidateSelection_Call {
	return &MockBatchJobInterface_ApplyCandidateSelection_Call{Call: _e.mock.On("ApplyCandidateSelection", ctx, resultID, source)}
}

func (_c *MockBatchJobInterface_ApplyCandidateSelection_Call) Run(run func(ctx context.Context, resultID string, source string)) *MockBatchJobInterface_ApplyCandidateSelection_Call {
...
func (_c *MockBatchJobInterface_ApplyCandidateSelection_Call) Return(movieResult *worker.MovieResult, provenanceData *worker.ProvenanceData, err error) *MockBatchJobInterface_ApplyCandidateSelection_Call {
	_c.Call.Return(movieResult, provenanceData, err)
	return _c
}

func (_c *MockBatchJobInterface_ApplyCandidateSelection_Call) RunAndReturn(run func(ctx context.Context, resultID string, source string) (*worker.MovieResult, *worker.ProvenanceData, error)) *MockBatchJobInterface_ApplyCandidateSelection_Call {
	_c.Call.Return(run)
	return _c
}
