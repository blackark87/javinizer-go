...
func TestIsDescriptiveNonName(t *testing.T) {
	tests := []struct {
		...
		{"appearance and anatomy blurb", "", "", "黒髪清楚系スジパイパン", true},
		{"short body-description girl", "", "", "クビレ美ボディ少女", true},
		{"school-description girl", "", "", "県立商業科色白少女", true},
		{"large-breasted woman description", "", "", "植え込みに頭突っ込んでたデカパイ女", true},
		{"weight-based promotional blurb", "", "", "体重37キロの逸材", true},
