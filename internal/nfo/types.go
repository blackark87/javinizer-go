...
// Actor represents an actress/actor in the movie. It is exported so focused
// workflows (such as actress metadata sync) can update only actor blocks while
// preserving every other, possibly user-defined, NFO element.
type Actor struct {
