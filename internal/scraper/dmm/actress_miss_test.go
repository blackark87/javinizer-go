...
func TestExtractRomajiVariantsFromActressPageCtx_Success(t *testing.T) {
	...
	variants := extractRomajiVariantsFromActressDoc(s.fetchActressPageDoc(context.Background(), 12345))
...
func TestExtractRomajiVariantsFromActressPageCtx_HTTPErrors(t *testing.T) {
	...
	cancel()
	variants := extractRomajiVariantsFromActressDoc(s.fetchActressPageDoc(ctx, 12345))
