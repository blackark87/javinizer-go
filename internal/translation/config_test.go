	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []fieldSpec{
				...
				{"TargetLanguages", reflect.TypeFor[[]string]()},
				{"TimeoutSeconds", typeFor[int]()},
				{"MaxConcurrency", typeFor[int]()},
				{"ApplyToPrimary", typeFor[bool]()},
				{"OverwriteExistingTarget", typeFor[bool]()},
				{"DictionaryEnabled", typeFor[bool]()},
				{"Dictionary", typeFor[string]()},
				...
				{"Bedrock", reflect.TypeFor[bedrockConfig]()},
			},
		},
		{
			name:  "fieldsConfig",
...
func TestTranslationConfigSourceShape(t *testing.T) {
	...
	assertStructShape(t, appconfig.TranslationConfig{}, []fieldSpec{
		...
		{"Bedrock", reflect.TypeFor[appconfig.BedrockTranslationConfig]()},
	})
